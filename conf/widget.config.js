...
module.exports = {
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/gh/alllike996/live2d@master/model/dollsfrontline/ntw20_2301/normal/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  // 音乐播放插件
  MUSIC_PLAYER: process.env.NEXT_PUBLIC_MUSIC_PLAYER || true, // 是否使用音乐播放插件false不使用，true使用
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      name: '凭什么你回头我就在',
      artist: '杨不乖',
      url: 'https://bed.273983.xyz/file/images/1762397449982_pingshmyangbuguai.mp3',// GitHub CDN加速：https://cdn.jsdelivr.net/gh/qinglong9627/NotionNext/public/music/pingshmyangbuguai.mp3
      cover:
