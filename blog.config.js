...
const BLOG = {
  ...
  LANGS: ['zh-CN', 'zh-HK', 'zh-TW', 'en-US', 'fr-FR', 'ja-JP', 'tr-TR'],  // 支持的语言列表
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WangLin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blognotion.caoys.dpdns.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'WangLin, 博客', // 网站关键词 英文逗号隔开
